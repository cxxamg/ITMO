package common.Engine.ScriptManage;
import common.Engine.*;
import common.Entity.*;
import common.FileManager.XmlReader;
...
public class AskScript {
    ...
    public static CityImport askCityImport(ArrayList<String> validatableValues) throws Ask.AskBreak{
        long cityIndex = 0;
        String name = null;
        Coordinates coordinates = null;
        float area = 0.0f;
